...
| `vscode-code-notes.aiToolCopilotModel`    | Copilot model to use (e.g., gpt-4.1, gpt-4o, o3)                                                                    | `string`  | `"gpt-4.1"`                                                                                          |
| `vscode-code-notes.aiToolAmpModel`        | Amp mode to use (rush or smart). Execute mode requires rush or smart.                                               | `string`  | `"smart"`                                                                                            |
